...
HD_PWD='C:/Mac/Home/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pe_8x8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pe_8x8_top.tcl
